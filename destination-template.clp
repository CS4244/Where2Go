(deftemplate destination
	...
	(multislot visitPreference (type STRING)(allowed-strings "Undiscovered" "Romantic" "Peace and Quiet" "Cultural" "Nightlife" "Family Friendly" "Leisure"))
	(slot region (type STRING)(allowed-strings "North America" "Europe" "Other"))
	(multislot geography (type STRING)(allowed-strings "Beach" "City" "Volcano" "Seaside" "Mountains" "Wilderness" "Island"))
	...
	(slot weather (type STRING) (allowed-strings "Hot" "Warm" "Mild" "Cold"))
)
